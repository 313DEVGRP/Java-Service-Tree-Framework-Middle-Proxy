...
MONITOR_ELK_OPTS="-javaagent:/elastic-apm-agent.jar -Delastic.apm.service_name=middle-proxy -Delastic.apm.application_packages=proxy.api -Delastic.apm.server_urls=http://192.168.25.31:8200"
