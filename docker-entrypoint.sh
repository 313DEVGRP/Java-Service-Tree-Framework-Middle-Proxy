...
MONITOR_ELK_OPTS="-javaagent:/elastic-apm-agent.jar -Delastic.apm.service_name=middle-com.proxy -Delastic.apm.application_packages=com.proxy.api -Delastic.apm.server_urls=http://192.168.25.46:8200"
