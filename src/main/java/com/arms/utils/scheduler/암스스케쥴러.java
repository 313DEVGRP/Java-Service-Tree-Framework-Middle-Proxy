...
public class 암스스케쥴러 {
    ...
    @Scheduled(cron="0 30 21 * * *") // 매일 오전 01(새벽)시에 실행
    ...
    public void 지라이슈_인덱스백업() {
        ...
        ResponseEntity 결과 = 내부통신기.지라이슈_인덱스백업();
        log.info(결과.toString());
    }
    ...
    public void 각_제품서비스_별_요구사항이슈_조회_및_ES저장() {
        ...
        ResponseEntity 결과 = 내부통신기.각_제품서비스_별_요구사항이슈_조회_및_ES저장();
        log.info(결과.toString());
    }
    ...
    public void 각_제품서비스_별_요구사항_Status_업데이트_From_ES() {
        ...
        ResponseEntity 결과 = 내부통신기.각_제품서비스_별_요구사항_Status_업데이트_From_ES();
        log.info(결과.toString());
    }
}
