...
RUN wget http://www.313.co.kr/nexus/content/repositories/StandardProject/313devgrp/metricbeat/1.0.0/metricbeat-1.0.0.yml
RUN mv metricbeat-1.0.0.yml ./metricbeat-7.4.2-linux-x86_64/metricbeat.yml
...
RUN wget http://www.313.co.kr/nexus/content/repositories/StandardProject/313devgrp/heartbeat/1.0.0/heartbeat-1.0.0.yml
RUN mv heartbeat-1.0.0.yml ./heartbeat-7.4.2-linux-x86_64/heartbeat.yml
...
RUN wget http://www.313.co.kr/nexus/content/repositories/StandardProject/313devgrp/filebeat/1.0.0/filebeat-1.0.0.yml
RUN mv filebeat-1.0.0.yml ./filebeat-7.4.2-linux-x86_64/filebeat.yml
...
RUN wget http://www.313.co.kr/nexus/content/repositories/StandardProject/313devgrp/scouter/1.0.0/scouter-1.0.0.conf
RUN mv scouter-1.0.0.conf /usr/local/tomcat/conf/scouter.conf
